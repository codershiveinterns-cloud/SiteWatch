...
export function FinalCta({ signedIn }: { signedIn: boolean }) {
  return (
    <section data-theme="dark" className="relative overflow-hidden bg-canvas py-20 text-ink lg:py-28" aria-labelledby="cta-title">
      <div aria-hidden className="absolute inset-0 bg-grid motion-ok:animate-drift [mask-image:radial-gradient(ellipse_at_center,black,transparent_70%)]" />
      <Reveal className="container-m relative text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-2.5 sm:flex-row">
          <Button asChild size="lg" className="link-arrow w-full sm:w-auto sm:min-w-36">
